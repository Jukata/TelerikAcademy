var snakeGame = (function () {
    ...
    var snakeHeadPieceFillColor = "#33BC99";
    var snakePieceFillColor = "#bbbbbb";
    var snakePieceStrokeColor = "#444444";
    var defaultSnakePieceSize = 10;

    var foodFillColor = "#FF7715";
    var foodStrokeColor = "#6DD711";
    var defaultSnakeSize = 5;

    var obstacleFillColor = "#000000";
    var obstacleStrokeColor = "#ffffff";
    var defaultObstacleCount = 10;
    var defaultObstacleSize = defaultSnakePieceSize;
    ...
    var SnakeGame = Class.create({
        ...
        initGameObjects: function () {
            ...
            for (var i = 0; i < defaultObstacleCount; i += 1) {
                var position = {
                    x: parseInt(Math.random() * (this.maxX / defaultObstacleSize)) * defaultObstacleSize,
                    y: parseInt(Math.random() * (this.maxY / defaultObstacleSize)) * defaultObstacleSize
                };
