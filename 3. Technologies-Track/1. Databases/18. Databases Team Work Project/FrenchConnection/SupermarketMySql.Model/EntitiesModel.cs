...
namespace SupermarketMySql.Model	
{
	public partial class SupermarketMySqlEntities : OpenAccessContext, ISupermarketMySqlEntitiesUnitOfWork
	{
		private static string connectionStringName = @"SupermarketMySqlConnection";
			
		private static BackendConfiguration backend = GetBackendConfiguration();
				
		private static MetadataSource metadataSource = XmlMetadataSource.FromAssemblyResource("EntitiesModel.rlinq");
		
		public SupermarketMySqlEntities()
			:base(connectionStringName, backend, metadataSource)
		{ }
		
		public SupermarketMySqlEntities(string connection)
			:base(connection, backend, metadataSource)
		{ }
		
		public SupermarketMySqlEntities(BackendConfiguration backendConfiguration)
	...
	public interface ISupermarketMySqlEntitiesUnitOfWork : IUnitOfWork
	{
