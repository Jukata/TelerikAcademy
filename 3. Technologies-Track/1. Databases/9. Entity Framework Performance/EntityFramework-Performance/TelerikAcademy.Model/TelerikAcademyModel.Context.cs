...
namespace TelerikAcademy.Model
{
    ...
    public partial class TelerikAcademyEntities : DbContext
    {
        ...
        public DbSet<AllUsersFromToday> AllUsersFromTodays { get; set; }
        ...
        public virtual ObjectResult<string> usp_AllEmployeesNamesAndTownsNameThatCanBeCreatedBy(string letters)
        {
            var lettersParameter = letters != null ?
                new ObjectParameter("letters", letters) :
                new ObjectParameter("letters", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("usp_AllEmployeesNamesAndTownsNameThatCanBeCreatedBy", lettersParameter);
        }
