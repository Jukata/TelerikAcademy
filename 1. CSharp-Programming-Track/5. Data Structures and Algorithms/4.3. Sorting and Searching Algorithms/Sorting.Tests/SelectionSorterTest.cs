...
namespace Sorting.Tests
{
    ...
    {
        [TestMethod]
        public void SelectionSorterTestWithEmptyCollection()
        {
        ...
        [TestMethod]
        public void SelectionSorterTestWithFiveElements()
        {
            SortableCollection<int> collection = new SortableCollection<int>(
                new int[] { 5, 12, -21, -1, 3 });
            collection.Sort(new SelectionSorter<int>());
        ...
        [TestMethod]
        public void SelectionSorterTestWithPairOfEqualElements()
        {
            SortableCollection<int> collection = new SortableCollection<int>(
        ...
        [TestMethod]
        public void SelectionSorterTestSortedCollection()
        {
            SortableCollection<int> collection = new SortableCollection<int>(
                           new int[] { -1, 0, 1, 2, 3 });
            collection.Sort(new SelectionSorter<int>());
        ...
        [TestMethod]
        public void SelectionSorterTestReversedSortedCollection()
        {
            SortableCollection<int> collection = new SortableCollection<int>(
