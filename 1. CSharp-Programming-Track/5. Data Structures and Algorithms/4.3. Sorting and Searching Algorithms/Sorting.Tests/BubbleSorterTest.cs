...
namespace Sorting.Tests
{
    ...
    {
        [TestMethod]
        public void BubbleSorterTestWithEmptyCollection()
        {
        ...
        [TestMethod]
        public void BubbleSorterTestWithOneElement()
        {
        ...
        [TestMethod]
        public void BubbleSorterTestWithFiveElements()
        {
            SortableCollection<int> collection = new SortableCollection<int>(
                new int[] { 5, 12, -21, -1, 3 });
            collection.Sort(new BubbleSorter<int>());
        ...
        [TestMethod]
        public void BubbleSorterTestWithPairOfEqualElements()
        {
            SortableCollection<int> collection = new SortableCollection<int>(
        ...
        [TestMethod]
        public void BubbleSorterTestSortedCollection()
        {
            SortableCollection<int> collection = new SortableCollection<int>(
                           new int[] { -1, 0, 1, 2, 3 });
            collection.Sort(new BubbleSorter<int>());
        ...
        [TestMethod]
        public void BubbleSorterTestReversedSortedCollection()
        {
            SortableCollection<int> collection = new SortableCollection<int>(
