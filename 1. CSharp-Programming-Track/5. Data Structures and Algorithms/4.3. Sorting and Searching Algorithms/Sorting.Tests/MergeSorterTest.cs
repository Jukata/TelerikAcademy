...
namespace Sorting.Tests
{
    ...
    {
        [TestMethod]
        public void MergeSorterTestWithEmptyCollection()
        {
        ...
        [TestMethod]
        public void MergeSorterTestWithOneElement()
        {
        ...
        [TestMethod]
        public void MergeSorterTestWithFiveElements()
        {
            SortableCollection<int> collection = new SortableCollection<int>(
                new int[] { 5, 12, -21, -1, 3 });
            collection.Sort(new MergeSorter<int>());
        ...
        [TestMethod]
        public void MergeSorterTestWithPairOfEqualElements()
        {
            SortableCollection<int> collection = new SortableCollection<int>(
        ...
        [TestMethod]
        public void MergeSorterTestSortedCollection()
        {
            SortableCollection<int> collection = new SortableCollection<int>(
                           new int[] { -1, 0, 1, 2, 3 });
            collection.Sort(new MergeSorter<int>());
        ...
        [TestMethod]
        public void MergeSorterTestReversedSortedCollection()
        {
            SortableCollection<int> collection = new SortableCollection<int>(
